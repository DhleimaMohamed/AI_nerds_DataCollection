...
#                             img_name = f'web1_{count}.{img_extension}'
...
# # Example usage     
# # target_url = 'http://www.worldlicenseplates.com/world/AF_MAUR.html' 
# target_url = 'https://www.flickr.com/search/?text=Mauritania+car+plates'
# patterns = [
#     r'\d{4}[ ]?[A-Z]{2}[ ]?\d{2}',  # Pattern to match '3120AC00', '7800AA07', etc.
#     r'(ASNA|CC|CD|IF|IT|ONU|SCC|SG|SP|TT|WT)[ ]?\d{3,6}',  # Pattern to match government plates with specific prefixes
# ]
